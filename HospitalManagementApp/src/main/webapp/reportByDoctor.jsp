...
<html>
<head>
    <title>Patients Assigned to Specific Doctor</title>
    <style>
        body {
...
<body>
    <h2>Report: Patients Assigned to Specific Doctor</h2>
    <form method="post" action="reportByDoctor.jsp">
        Enter Doctor Name: 
        <input type="text" name="doctor" required
               value="<%= request.getParameter("doctor") != null ? request.getParameter("doctor") : "" %>">
...
%>
    ...
    <div class="search-criteria">
        <p><strong>Doctor:</strong> <%= doctor.trim() %></p>
    </div>
...
<%
            ...
            if (!found) {
%>
                <tr><td colspan="7" style="text-align:center; font-style: italic;">No patients found assigned to this doctor.</td></tr>
<%
            }
            rs.close();
            ps.close();
